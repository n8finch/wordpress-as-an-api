...
1. Unzip this project (you proabbly already did that).
2. Make sure you have `npm` or `yarn` available globally, if not, install them. Since `create-react-app` below uses yarn commands, I will too...
